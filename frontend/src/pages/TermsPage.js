        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-purple-600">AI Seller Agent</span>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              Welcome to AI Seller Agent. These Terms of Service ("Terms") govern your access to and use of our service. Please read them carefully.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed font-semibold">
              By accessing or using AI Seller Agent, you agree to be bound by these Terms. If you do not agree, do not use our service.
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-700 text-sm">
                  <li>• AI Seller Agent is a tool to help optimize Etsy listings—results are not guaranteed</li>
                  <li>• You are responsible for complying with Etsy's policies when implementing our recommendations</li>
                  <li>• We are not affiliated with or endorsed by Etsy, Inc.</li>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>By creating an account, accessing, or using AI Seller Agent, you confirm that:</p>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>AI Seller Agent provides:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>AI-powered analysis of Etsy product listings</li>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>We do not directly modify your Etsy listings—you choose which recommendations to implement</li>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p>To use AI Seller Agent, you must:</p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Manipulate Markets:</strong> Coordinate with others to artificially manipulate Etsy rankings</li>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p>AI Seller Agent and all related content, features, and functionality are owned by us and protected by copyright, trademark, and other intellectual property laws.</p>
              ...
              <p>You retain all rights to the Etsy listing content you submit. By using our service, you grant us a limited license to:</p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Etsy API:</strong> For retrieving listing data (subject to Etsy's Terms of Use)</li>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Actions taken by Etsy based on your use of our recommendations</li>
              </ul>
              <p className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <strong>Important:</strong> You must comply with Etsy's Terms of Use, Seller Policy, and all other applicable policies when using AI Seller Agent.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p className="font-semibold">AI SELLER AGENT IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND.</p>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2">
                ...
                <li>We are not responsible for actions taken by Etsy or other third parties</li>
              </ul>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>You agree to indemnify, defend, and hold harmless AI Seller Agent, its owners, employees, and affiliates from any claims, damages, losses, or expenses (including legal fees) arising from:</p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p>Your continued use of AI Seller Agent after changes constitutes acceptance of the updated Terms.</p>
              <p className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <ul className="list-disc pl-6 space-y-3">
                <li><strong>Entire Agreement:</strong> These Terms constitute the entire agreement between you and AI Seller Agent</li>
          ...
          <section className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 border-2 border-purple-200">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div className="bg-white rounded-xl p-6 space-y-3">
                <div>
                  <p className="font-bold text-gray-800">AI Seller Agent</p>
                  <p className="text-sm text-gray-600">Etsy Listing Optimization Service</p>
                </div>
                <div>
          ...
          <div className="mt-12 p-6 bg-gray-900 text-white rounded-xl">
            <p className="text-center font-semibold mb-3">
              By clicking "I Agree" or using AI Seller Agent, you acknowledge that:
            </p>
            <ul className="space-y-2 text-sm text-white/90">
              <li>✓ You have read and understood these Terms of Service</li>
              <li>✓ You agree to be legally bound by these Terms</li>
              <li>✓ You are 18+ years old or have parental consent</li>
              <li>✓ You will comply with all applicable laws and Etsy policies</li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">AI Seller Agent</span>
              </div>
