        ...
        <div className="max-w-7xl mx-auto px-4 py-20 md:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-purple-100 max-w-3xl mx-auto">
              Get exact, copy-paste ready improvements for your Etsy listings in 30 seconds.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-600">
                Every suggestion comes with exact text you can copy and paste directly into your Etsy listing.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Copy your Etsy listing details - title, tags, price, description.
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Increase Your Etsy Sales?
          </h2>
