...
function FeaturesPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Stop wasting time rewriting. Every suggestion comes ready to copy and paste directly into your Etsy listing.",
      benefits: [
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 border-2 border-purple-300">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-purple-600">AI Seller Agent</h3>
              </div>
              <ul className="space-y-4">
                {comparisonPoints.map((point, index) => (
      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Six powerful features designed to increase your Etsy sales
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-white/80">Copy your Etsy title, description, tags, and price into our analyzer</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white/80">Get exact replacements ready to paste directly into your Etsy listing</p>
            </div>
          </div>
      ...
      <div className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join Etsy sellers who are getting exact, actionable recommendations
