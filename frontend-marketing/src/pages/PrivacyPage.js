        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              AI Seller Agent ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              By using AI Seller Agent, you agree to the collection and use of information in accordance with this policy.
            </p>
          </div>
          ...
          <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-8 mb-12">
            ...
            <ul className="space-y-3 text-gray-700">
              ...
              <li className="flex items-start gap-2">
                <span className="text-purple-600 text-xl">•</span>
                <span>Your Etsy listing data is used solely for analysis and improvement recommendations</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-600 text-xl">•</span>
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><strong>Etsy Listing Data:</strong> Product titles, descriptions, tags, prices, categories, and images that you submit for analysis</li>
              ...
              <div>
                ...
                <p className="mb-3">If you connect your Etsy account:</p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>We access your public Etsy shop information via the Etsy API</li>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Service Delivery:</strong> To analyze your Etsy listings and provide optimization recommendations</li>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1 mt-2">
                    ...
                    <li><strong>Etsy API:</strong> For retrieving your authorized listing data</li>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p className="mt-4 text-sm bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <strong>Note:</strong> While we strive to protect your data, no method of transmission over the internet is 100% secure. Use AI Seller Agent at your own risk.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p>Disconnect your Etsy account authorization at any time</p>
                </div>
              </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>Our service may contain links to third-party websites (e.g., Etsy, competitor listings). We are not responsible for the privacy practices of these external sites. We encourage you to read their privacy policies.</p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>AI Seller Agent is not intended for users under 18 years of age. We do not knowingly collect personal information from children. If you believe a child has provided us with personal information, please contact us immediately.</p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p>Continued use of AI Seller Agent after changes constitutes acceptance of the updated policy.</p>
            </div>
          </section>
          ...
          <div className="mt-12 p-6 bg-gray-50 rounded-xl border border-gray-200">
            <p className="text-sm text-gray-600 text-center">
              By using AI Seller Agent, you acknowledge that you have read and understood this Privacy Policy and agree to its terms.
            </p>
          </div>
        </div>
      </div>
