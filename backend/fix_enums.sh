...
echo "🔧 Fixing database enums properly..."

# Fix User.js enums
cat > src/models/user/User.js << 'USERMODEL'
...
# Fix CustomRole.js
cat > src/models/user/CustomRole.js << 'ROLEMODEL'
const mongoose = require('mongoose');
...
echo "  ✅ Fixed CustomRole.js"

echo ""
echo "✅ Database enums fixed!"
