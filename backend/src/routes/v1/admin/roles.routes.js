...
router.post('/', adminAuth, checkPermission('roles.create'), async (req, res) => {
  try {
...
router.put('/:id', adminAuth, checkPermission('roles.edit'), async (req, res) => {
  try {
...
router.delete('/:id', adminAuth, checkPermission('roles.delete'), async (req, res) => {
  try {
    const role = await CustomRole.findById(req.params.id);
...
// @access  Private (Admin with roles.view permission)
router.get('/permissions/available', adminAuth, checkPermission('roles.view'), async (req, res) => {
  try {
