  ...
  try {
    ...
    if (!user.canAnalyze()) {
      return res.status(403).json({
        success: false,
        message: `Analysis limit reached. You've used ${user.analysisCount}/${user.analysisLimit} analyses. Please upgrade your plan.`,
...
ORDER NOW and get FREE gift wrapping with your purchase!`,
      ...
      optimizedTags: [
        ...
        { tag: 'handmade quality', reasoning: 'Etsy shoppers specifically search this, 8K monthly searches' },
    ...
    // Mock competitor data (will be from Etsy API later)
    const competitors = [
      ...
      { title: 'Top Rated Seller | Premium Gift', price: price * 1.15, sales: 580, ranking: 1 },
      { title: 'Artisan Made | Custom Orders', price: price * 1.4, sales: 210, ranking: 8 },
      { title: 'Best Seller | Fast Shipping', price: price * 1.25, sales: 390, ranking: 3 }
    ];
    ...
    res.json({
      ...
      usage: {
        ...
        remaining: user.analysisLimit - user.analysisCount
      }
    });
