...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/api/v1/auth/customer/login', {
        method: 'POST',
      ...
      <div className="flex-grow flex items-center justify-center px-4 py-12">
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to your AI Seller Agent account</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">Secure login · Instant access · Free trial available</p>
          </div>
        </div>
      </div>
    </div>
